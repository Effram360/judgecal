...
class TestUnderpoweredFlag:
    """Design-based power semantics (claims review M4): the MDE is compared
    ...
    def test_quiet_when_mde_at_or_below_floor(self) -> None:
        # Reviewer's n=800 null-judge repro (claims review M4): observed
    ...
    def test_no_banned_phrases(self) -> None:
        ...
        for card in cards:
            ...
            for phrase in BANNED_PHRASES:
                assert phrase not in md, f"banned phrase in card markdown: {phrase!r}"
